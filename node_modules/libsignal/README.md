# libsignal-node (Atex Ovi Version)
...
![npm version](https://img.shields.io/npm/v/@atex-ovi/libsignal-node.svg)
![npm license](https://img.shields.io/npm/l/@atex-ovi/libsignal-node.svg)
